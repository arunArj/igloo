...
<body class="site_home">
    ...
    <div class="wrapper">
        ...
        <div class="position-absolute promo-unit-home animated bounceInUp"><img src="<?php echo base_url() ?>assets/frontend/oman/images/promo-unit-home-products.png" alt="" class="img-fluid"></div>
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12 custom-margin-top">
                   <img src="<?php echo base_url() ?>assets/frontend/oman/images/screen01mobile.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
            <footer>
            ...
            <div class="row">
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <a href="<?php echo base_url() ?>oman/registration" class="btn registration-btn animated pulse infinite"><img src="<?php echo base_url() ?>assets/frontend/images/register-btn.png" alt=""></a>
                </div>
            </div>
        </div>
            </footer>
